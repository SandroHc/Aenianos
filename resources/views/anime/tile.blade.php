<div class="mdl-card mdl-shadow--2dp mdl-cell mdl-cell--8-col" style="margin: 15px auto">
	...
	<div class="mdl-card__title" style="padding-bottom:7px">
		...
		@if(Auth::check())
			<button id="news-{{ $data->id }}" class="mdl-button mdl-js-button mdl-button--icon" style="{{ empty($data->cover) ? 'margin-right: 126px' : '' }}">
		...
		<div style="position:absolute; right:16px; top:24px">
			...
			@endif
			<button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored" onclick="window.location='{!! URL::action('AnimeController@showDetail', [ 'id' => $data->id ]) !!}'">
